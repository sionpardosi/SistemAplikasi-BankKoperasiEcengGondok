                    ...
                    <div id="accordion-filter-1" class="accordion-collapse collapse show border-0"
                        ...
                        <div class="accordion-body px-0 pb-0 pt-3">
                            <ul class="list list-inline mb-0">
                                <li class="list-item">
                                    <a href="#" class="menu-link py-1">Sendal Hotel</a>
                                </li>
                                <li class="list-item">
                                    <a href="#" class="menu-link py-1">Topi</a>
                                </li>
                                <li class="list-item">
                                    <a href="#" class="menu-link py-1">Cover Book</a>
                                </li>
                                <li class="list-item">
                                    <a href="#" class="menu-link py-1">Tas</a>
                                </li>
                                <li class="list-item">
                                    <a href="#" class="menu-link py-1">Sendal Premium</a>
                                </li>
                                <li class="list-item">
                                    <a href="#" class="menu-link py-1">ToteBag</a>
                                </li>
                                <li class="list-item">
                                    <a href="#" class="menu-link py-1">Keranjang Kecil</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="swiper-wrapper">
                            ...
                            <div class="slide-split_text position-relative d-flex align-items-center"
                                ...
                                <div class="slideshow-text container p-3 p-xl-5">
                                    <h2
                                        ...
                                        Eceng Gondok <br /><strong>Aksesoris</strong></h2>
                                    <p class="mb-0 animate animate_fade animate_btt animate_delay-5">eceng
                                        gondok...</h6>
                                </div>
                            </div>
                            <div class="slide-split_media position-relative">
                                <div class="slideshow-bg" style="background-color: #f5e6e0;">
                                    <img loading="lazy" src="assets/images/products/banner3.jpg" width="630" height="450"
                    ...
                    <div class="swiper-slide">
                        <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                            ...
                            <div class="slide-split_media position-relative">
                                <div class="slideshow-bg" style="background-color: #f5e6e0;">
                                    <img loading="lazy" src="assets/images/products/banner1.jpg"
                    ...
                    <div class="swiper-slide">
                        <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                            ...
                            <div class="slide-split_media position-relative">
                                <div class="slideshow-bg" style="background-color: #f5e6e0;">
                                    <img loading="lazy" src="assets/images/products/banner2.jpg" width="630" height="450"
                                        alt="" class="slideshow-bg__img object-fit-cover" />
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                        <div class="pc__img-wrapper">
                            <div class="swiper-container background-img js-swiper-slider"
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a href="details.html"><img loading="lazy" src="assets/images/products/sendal.jpg" width="330"
                                                height="400" alt="" class="pc__img"></a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="details.html"><img loading="lazy"
                                                src="assets/images/products/sendal.jpg" width="330"
                            ...
                            <button
                                ...
                                data-aside="cartDrawer" title="Add To Cart">Tambahkan Keranjang</button>
                        </div>

                        <div class="pc__info position-relative">
                            <p class="pc__category">Sendal Hotel</p>
                            <h6 class="pc__title"><a href="details.html">Sendal Hotel Eceng Gondok Gorga</a></h6>
                ...
                <div class="product-card-wrapper">
                    <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                        ...
                        <div class="pc__info position-relative">
                            ...
                            <h6 class="pc__title"><a href="details.html">Sendal Hotel</a></h6>
                            <div class="product-card__price d-flex">
                        ...
                        <div class="pc__img-wrapper">
                            <div class="swiper-container background-img js-swiper-slider"
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <a href="details.html"><img loading="lazy"
                                                src="assets/images/products/product_3-1.jpg" width="330"
                                                height="400" alt="Cropped Faux leather Jacket"
                                                class="pc__img"></a>
                                    </div>
                                </div>
                    ...
                    <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                        <div class="pc__img-wrapper">
                            <div class="swiper-container background-img js-swiper-slider"
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a href="details.html"><img loading="lazy" src="assets/images/products/sendal.jpg"
