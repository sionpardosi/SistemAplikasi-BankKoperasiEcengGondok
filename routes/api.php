...
// ====================================================================================================
// Stock API untuk produk
// ====================================================================================================
Route::get('/product/{id}/stock', [ShopController::class, 'getProductStock']);
Route::get('/product/{id}/stock', [ShopController::class, 'getProductStock']);
Route::get('/product/{id}/check-stock', [ShopController::class, 'checkProductStock']);
