...
<body>
    ...
    <table>
        ...
        <tr>
            <td>Pendapatan Penjualan Online</td>
            <td class="text-right">Rp {{ number_format($pendapatanOnline, 0, ',', '.') }}</td>
        </tr>
        <tr>
            <td>Pendapatan Penjualan Offline</td>
            <td class="text-right">Rp {{ number_format($pendapatanOffline, 0, ',', '.') }}</td>
        </tr>
        <tr class="total-row">
        ...
        <tr>
            ...
            <td class="text-right">Rp {{ number_format($bebanBahanBaku, 0, ',', '.') }}</td>
        </tr>
        <tr>
        ...
        <td class="text-right">Rp {{ number_format($bebanOperasional, 0, ',', '.') }}</td>
        </tr>
        <tr>
            <td>Beban Lain-lain</td>
            <td class="text-right">Rp {{ number_format($bebanLainLain, 0, ',', '.') }}</td>
        </tr>
        <tr class="total-row">
            <td>Total Beban</td>
