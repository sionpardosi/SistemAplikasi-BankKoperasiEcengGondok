    ...
    <div class="main-content-inner">
        <div class="main-content-wrap">
            <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                <h3>Edit Informasi Halaman Deskripsi Pemasok</h3>
                <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                    ...
                    <li>
                        <a href="{{ route('admin.adminsupplier.informasi_supplier.index') }}">
                            <div class="text-tiny">Informasi Pemasok</div>
                        </a>
                    </li>
                    <li><i class="icon-chevron-right"></i></li>
                    <li>
            ...
            <div class="wg-box">
                <div class="wg-box-content">
                    <form action="{{ route('admin.adminsupplier.informasi_supplier.update', $supplierInfo->id) }}" method="POST"
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" id="title"
                                        ...
                                        value="{{ old('title', $supplierInfo->title) }}" required>
                                    @error('title')
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <textarea name="description" id="description" rows="5"
                                        class="form-control @error('description') is-invalid @enderror" required>{{ old('description', $supplierInfo->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select name="video_type" id="video_type" class="form-control"
                                        ...
                                        <option value="local" {{ old('video_type', $supplierInfo->video_type) == 'local' ? 'selected' : '' }}>Video
                                            Lokal</option>
                                        <option value="instagram" {{ old('video_type', $supplierInfo->video_type) == 'instagram' ? 'selected' : '' }}>
                                ...
                                <div id="localVideoSection" class="mt-3" style="display: none;">
                                    <div class="form-group">
                                        @if($supplierInfo->video_type == 'local' && $supplierInfo->video_url)
                                            <div class="mb-2">
                                                <p>Video Saat Ini: {{ basename($supplierInfo->video_url) }}</p>
                                                <video width="320" height="240" controls class="mt-2 mb-2">
                                                    <source src="{{ asset($supplierInfo->video_url) }}" type="video/mp4">
                                                    Browser Anda tidak mendukung tag video.
                                                </video>
                                            </div>
                                        @endif
                                        <label for="video_file">Upload Video Baru</label>
                                        ...
                                        @error('video_file')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        <small class="form-text text-muted">Format yang didukung: MP4, MOV, AVI. Biarkan kosong jika tidak ingin mengubah video</small>
                                    </div>
                                ...
                                <div id="instagramVideoSection" class="mt-3" style="display: none;">
                                    <div class="form-group">
                                        ...
                                        <input type="url" name="instagram_url" id="instagram_url"
                                            ...
                                            value="{{ old('instagram_url', $supplierInfo->video_type == 'instagram' ? $supplierInfo->video_url : '') }}"
                                            placeholder="https://www.instagram.com/p/XXXXXXXXXXXX/">
                                        @error('instagram_url')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        <small class="form-text text-muted">Masukkan URL dari video/post/reel Instagram</small>
                                    </div>
                                </div>
                                ...
                                <div id="videoDetailsSection" class="mt-3" style="display: none;">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="video_caption" id="video_caption"
                                            ...
                                            value="{{ old('video_caption', $supplierInfo->video_caption) }}">
                                        @error('video_caption')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        @if($supplierInfo->video_thumbnail)
                                            <div class="mb-2">
                                                <img src="{{ asset($supplierInfo->video_thumbnail) }}" alt="Video Thumbnail"
                                                    class="img-thumbnail" style="max-width: 200px; max-height: 200px;">
                                            </div>
                                        @endif
                                        ...
                                        @error('video_thumbnail')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        <small class="form-text text-muted">Opsional. Biarkan kosong jika tidak ingin mengubah thumbnail</small>
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <input type="text" name="video_duration" id="video_duration"
                                            ...
                                            value="{{ old('video_duration', $supplierInfo->video_duration) }}" placeholder="01:30">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="order" id="order"
                                        ...
                                        value="{{ old('order', $supplierInfo->order) }}" min="0">
                                    @error('order')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-check mt-3">
                                    <input type="checkbox" name="is_active" id="is_active" class="form-check-input"
                                        {{ old('is_active', $supplierInfo->is_active) ? 'checked' : '' }} value="1">
